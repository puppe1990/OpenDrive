defmodule OpenDriveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OpenDriveWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OpenDriveWeb.Gettext, "errors", msg, opts)
    end
  end
